...
# Certifications
# Rigoberto Alvarez | Cybersecurity & IT Portfolio

Welcome! I’m Rigoberto Alvarez, an early-career cybersecurity and IT professional focused on defensive security, troubleshooting, and hands-on lab learning.
...
- SIEM awareness and log analysis concepts
- Virtualization and Linux-based security labs

## 🧰 Core Skills
- Security Information and Event Management (SIEM) fundamentals
- Windows 10 / Windows Server administration basics
- Troubleshooting and incident documentation
- Printer setup and network device configuration
- Kali Linux lab usage
- HTML basics and Visual Studio Code
- Microsoft Word, Excel, and PowerPoint
- Bilingual communication (English/Spanish)

## 🎓 Education
- **College of Southern Nevada (CSN)** — Computer Science (In Progress)
  - GPA: 4.0
  - President’s List (Fall 2024)
- **Rancho High School** — Standard Diploma
  - GPA: 3.3
...
### MedCerts Fundamentals of IT Student (Hands-on)
- Operated virtual machines for IT and security simulations.
- Diagnosed application failures using Task Manager and Event Viewer.
- Installed and configured local/network printers.
- Created technical documentation for troubleshooting results.
- Used Kali Linux in a virtual lab for security practice.

### Retail Leadership & Operations Experience
Experience in management and customer-facing operations helped strengthen:
- Team communication
- Process consistency
...
## 🚀 Current Goals
- Build more cybersecurity home-lab projects
- Publish guided writeups and troubleshooting notes
- Grow practical skills in SOC workflows and entry-level IT support

---

## Repository Structure
- `README.md` — GitHub profile-style summary
- `index.md` — Portfolio page for GitHub Pages
- `_config.yml` — Jekyll site settings

## Notes
If you are a recruiter or hiring manager, thank you for visiting. I’m actively developing my cybersecurity and IT skillset and open to entry-level opportunities.
